    ...
    void Start(){
        ...
        if(autoGenerateCrosshair || drawPrimitiveUI){
            ...
            if(autoGenerateCrosshair && crosshairSprite){
                ...
                crosshairImg.rectTransform.sizeDelta = new Vector2(20,20);
                crosshairImg.transform.SetParent(canvas.transform);
                    crosshairImg.transform.position = new Vector3(transform.position.x, transform.position.y + 20, transform.position.z);
